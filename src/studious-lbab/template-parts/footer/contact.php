...
if( empty( $aImage )){
    ...
    echo '<img src="assets/img/logo/lbab-144x144.png" alt="Logo de la boîte à bouillons" width="144" height="144" />', PHP_EOL;
} else {
    // Custom Logo
    echo sprintf( '<img src="%1$s" alt="Logo de la boîte à bouillons" width="%2$d" height="%3$d" />', esc_url( $aImage[0] ), esc_attr( $aImage[1] ), esc_attr( $aImage[2] )), PHP_EOL;
}
?>
</picture>
<h5><strong>CONTACT</strong></h5>
<p>Anne-Sophie&nbsp;Evrard<br />
La boîte à bouillons - Nantes<br />
&#9743;&nbsp;<a href="tel:0663354236">06 63 35 42 36</a><br />
&#9993;&nbsp;<a href="mailto:contact@laboîteabouillons.fr">contact@laboîteabouillons.fr</a><br />
Retrouvez-nous sur&nbsp;<a href="https://www.facebook.com/laboîteabouillons/" title="Aller sur la page facebook de La boîte à bouillons" rel="external">
<picture>
